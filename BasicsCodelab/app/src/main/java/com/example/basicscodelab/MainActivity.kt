...
private fun Greetings(
    ...
    // When we have a lot of items, LazyColumn gives us a better performance
        ...
        Row(modifier = Modifier.padding(24.dp)
            ...
            IconButton(onClick = { expanded.value = !expanded.value}) {
                Icon(if (expanded.value) Icons.Filled.ExpandLess else Icons.Filled.ExpandMore,
                    contentDescription = if (expanded.value) R.string.show_less.toString() else R.string.show_more.toString())
            }
